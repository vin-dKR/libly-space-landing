...
const HowItWorks = () => {
    return (
        <div id="how-it-works" className="w-full bg-blue-50">
            <div className="max-w-6xl mx-auto py-16 sm:py-20 px-4 sm:px-6 lg:px-8">
                {/* Header Section */}
                ...
                <div className="relative">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link
                            ...
                            className="bg-white text-blue-600 hover:bg-blue-50 px-8 py-3 rounded-xl font-semibold text-sm transition-all duration-300 hover:scale-105 hover:shadow-lg inline-flex items-center justify-center"
                        >
                            Sign Up for Free
                        </Link>
                        <Link
                            href="/pricing"
                            className="border border-blue-300 bg-blue-600/20 text-white hover:bg-blue-600/30 px-8 py-3 rounded-xl font-semibold text-sm transition-all duration-300 hover:scale-105 backdrop-blur-sm inline-flex items-center justify-center"
                        >
                            View Pricing
                        </Link>
                    </div>
