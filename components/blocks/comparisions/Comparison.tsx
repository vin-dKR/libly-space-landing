...
const Comparison = () => {
    return (
        <div id="comparison" className="w-full bg-blue-50">
            <div className="py-16 sm:py-24 md:py-32 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                    ...
                    <div className="relative group">
                        <div className="absolute inset-0 bg-gradient-to-br from-blue-100 to-white rounded-2xl transform group-hover:scale-[1.01] transition-all duration-300"></div>
                        <div className="relative rounded-2xl border border-blue-100 bg-white/80 backdrop-blur-sm p-5 sm:p-6">
                            <div className="text-center pb-4 mb-4 border-b border-blue-100">
                                ...
                                <h2 className="text-xl sm:text-2xl font-light text-gray-900 mb-1">Traditional Systems & Basic Apps</h2>
                                <p className="text-gray-500 text-xs font-normal">Excel, Manual Records & Other Apps</p>
                            </div>
